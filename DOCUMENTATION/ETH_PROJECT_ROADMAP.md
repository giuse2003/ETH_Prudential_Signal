...
- [x] Allineare `README.md`, `PROJECT_OVERVIEW.md`,
      ...
      Baseline ufficiale.
- [x] Rimuovere Render/FastAPI dopo verifica del Worker e di zero servizi
      attivi nel pannello Render.
- [x] Aggiungere `BASELINE_SYNC_CHECKLIST.md` per gli allineamenti trasversali.
